...
#define DEVICE_UNIQUE_ID "a488fcd7-1717-4fb3-95f3-8f56818714e1" //{"UniqueId":"a488fcd7-1717-4fb3-95f3-8f56818714e1","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
#define ENABLED_OLEDLCD 1 //{"Group":"Oled GLCD","Name":"ENABLED_OLEDLCD","Title":"OLED LCD enabled","DefaultValue":"0","Type":"bool","Pins":"nano:18,OLED LCD SDA;19,OLED LCD SCK|uno:18,OLED LCD SDA;19,OLED LCD SCK|micro:2,OLED LCD SDA;3,OLED LCD SCK"}
#ifdef INCLUDE_OLED
